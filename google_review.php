<div class="wrap">
    ...
    <form method="post" action="options.php">
        <?php settings_fields('tfw-google-review-settings-group'); ?>
        <?php do_settings_sections('tfw-google-review-settings-group'); ?>
        <table class="form-table">
            <tr valign="top">
            <th scope="row">Google pb ID</th>
            <td><input style="width: 100%;" type="text" name="tfw_google_place_id" value="<?php echo esc_attr(get_option('tfw_google_place_id')); ?>" />
