<?php
/*
Plugin Name: TalkforWEB Review Plugin
Description: Fetch all Google Reviews using cookies 
Author: Vinay
Version: 1.0
...
add_action('admin_menu', 'google_review_link');

function google_review_link()
{

    //create new top-level menu
    add_menu_page('Google Review', 'Google Review', 'administrator', __FILE__, 'tfw_google_review');
...
function register_plugin_settings()
{
    ...
    register_setting('tfw-google-review-settings-group', 'tfw_google_place_id');
}

function tfw_google_review()
{
...
function talforweb_create_database_table()
{
    ...
    dbDelta($sql);
    //add example value
    add_option('tfw_google_place_id', '!1m2!1y7715437134510776335!2y10307002471025652395!2m2!2i28!2i10!3e1!4m5!3b1!4b1!5b1!6b1!7b1!5m2!1srnuUXvOCEY7H4-EPpPuuUA!7e81');
...
function talforweb_scripts(){
     ...
     wp_enqueue_script( 'TFW-google-JS', plugins_url( 'js/js.js', __FILE__ ), array(), '1.0.0' );
}
...
?>
  <div class="tfw_container">
    <div class="tfw_logoimg"><img src="<?php echo plugin_dir_url(__FILE__); ?>images/google-review.png" /></div>
      <?php
